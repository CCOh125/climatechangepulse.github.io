...
// Add a check to see if the user is on the home page or visualization page
// This is to ensure we only initialize the visualization on the visualization page
